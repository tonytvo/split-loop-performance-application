...
@RestController
@RequestMapping("/api/split-loop-performance-kafka")
public class SplitLoopPerformanceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SplitLoopPerformanceKafkaResource.class);
    ...
    public SplitLoopPerformanceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
